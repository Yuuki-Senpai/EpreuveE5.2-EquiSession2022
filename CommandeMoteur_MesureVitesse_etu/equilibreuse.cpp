    ...
    , ui(new Ui::Equilibreuse)
{
    ...
    connect(leCodeur,&Codeur::VitesseChange,this,&Equilibreuse::onCodeur_VitesseChance);
}
...
void Equilibreuse::onCodeur_VitesseChance(int vit)
{
    ui->lcdNumber_vitesse->display(QString::number(vit));
}
